...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`seata_order_1` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `order_info_0`(`id`,`order_name`,`product_id`,`buy_num`,`create_time`,`update_time`) values (1387382592208240641,'测试数据',NULL,2,'2021-04-28 20:26:00','2021-04-28 20:26:00');
...
insert  into `order_info_2`(`id`,`order_name`,`product_id`,`buy_num`,`create_time`,`update_time`) values (1387382407474315265,'测试数据',NULL,2,'2021-04-28 20:25:17','2021-04-28 20:25:17');
