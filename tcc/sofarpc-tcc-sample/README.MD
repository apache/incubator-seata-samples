...
运行 [FescarServerStarter](https://github.com/fescar-group/fescar-samples/blob/master/tcc/sofarpc-tcc-sample/src/test/java/com/alibaba/fescar/samples/tcc/server/FescarServerStarter.java) ，启动 Fescar Server；


#### step 2 启动 sofarpc 服务

运行 [SofaRpcTccProviderApplication](https://github.com/fescar-group/fescar-samples/blob/master/tcc/sofarpc-tcc-sample/src/test/java/com/alibaba/fescar/samples/tcc/provider/SofaRpcTccProviderApplication.java)

本应用发布TCC sofa-rpc 服务；

#### step 2 启动 TCC Demo

运行 [SofaRPCTccTransactionApplication](https://github.com/fescar-group/fescar-samples/blob/master/tcc/sofarpc-tcc-sample/src/main/java/com/alibaba/fescar/samples/tcc/sofarpc/starter/SofaRPCTccTransactionApplication.java) , 启动 demo工程；
