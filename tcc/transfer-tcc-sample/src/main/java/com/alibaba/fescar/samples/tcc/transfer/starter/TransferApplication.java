package com.alibaba.fescar.samples.tcc.transfer.starter;


import com.alibaba.fescar.samples.tcc.transfer.activity.TransferService;
import com.alibaba.fescar.samples.tcc.transfer.dao.AccountDAO;
import com.alibaba.fescar.samples.tcc.transfer.domains.Account;
import com.alibaba.fescar.samples.tcc.transfer.env.TransferDataPrepares;
...
public class TransferApplication {
    ...
    public static void main(String[] args) throws SQLException {
        applicationContext = new ClassPathXmlApplicationContext("spring/fescar-tcc.xml", "spring/fescar-dubbo-reference.xml",
